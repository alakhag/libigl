...
int main(int argc, char *argv[])
{
  ...
  Eigen::MatrixXd Q;
  Eigen::MatrixXi QF;
  igl::read_triangle_mesh(argv[2],Q,QF);
...
//         break;
//       case 3:
//         viewer.data_list[query_data].set_points(QiVo,Eigen::RowVector3d(0.564706,0.847059,0.768627));
//         break;
//     }
...
//   2  Toggle hiding query points, showing query points, showing inside queries, showing outside queries
// )";
